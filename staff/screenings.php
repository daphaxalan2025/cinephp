<?php
// staff/screenings.php - PROFESSIONAL DESIGN (Admin-style) - All staff logic preserved
                ...
                html += `
                    <div class="screening-card">
                        ...
                        <div class="screening-details">
                            ...
                            <div class="detail-item">💰 <strong>Price:</strong> ₱${parseFloat(s.price).toFixed(2)}${priceDiff ? ` <span style="color:#ff8844;">(Movie: ₱${parseFloat(s.movie_price).toFixed(2)})</span>` : ''}</div>
                        ...
                        <div class="action-buttons">
                            ...
                            <a href="tickets_list.php?screening_id=${s.id}" class="btn-action" style="border-color:#44ff44; color:#44ff44;">🎟️ Tickets</a>
                        </div>
                    </div>
                `;
            }
